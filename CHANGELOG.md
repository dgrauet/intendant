...
* **packaging:** bundle handbook, ADRs and templates in the wheel ([#54](https://github.com/dgrauet/intendant/issues/54)) ([145b3e5](https://github.com/dgrauet/intendant/commit/145b3e5cf27f71a40f14962c741a5f383a317427))

## [4.0.2](https://github.com/dgrauet/intendant/compare/v4.0.1...v4.0.2) (2026-05-31)


### Bug Fixes

* detector accuracy (CI004 cache markers + Rust workspace tests) ([#52](https://github.com/dgrauet/intendant/issues/52)) ([b7c22d0](https://github.com/dgrauet/intendant/commit/b7c22d0d4817d70c453b56074bdef2616779902d))
...
* **scaffold:** add Swift scaffolder ([#45](https://github.com/dgrauet/suzerain/issues/45)) ([61f3964](https://github.com/dgrauet/suzerain/commit/61f39643cfcbd529354b29bbcd8f0b50d7947ef1))
...
* **adapters:** add Swift adapter (7 rules, SwiftPM) ([#39](https://github.com/dgrauet/suzerain/issues/39)) ([f165fce](https://github.com/dgrauet/suzerain/commit/f165fce613d0ac56c8e81068e9f7db9bafd6b74e))
...
* promote suzerain to 1.0 — production/stable ([64610ee](https://github.com/dgrauet/suzerain/commit/64610ee601e16f5a318196cc925da1462bd1bf4c))

## [0.4.5](https://github.com/dgrauet/suzerain/compare/v0.4.4...v0.4.5) (2026-05-04)


### Features

* **scaffold:** add Go scaffolder (suzerain new --stack=go) ([#30](https://github.com/dgrauet/suzerain/issues/30)) ([b7bac8a](https://github.com/dgrauet/suzerain/commit/b7bac8a17335534e19889d440c315bca00e1287b))
...
* **adapter:** add Rust adapter with 7 rules (palier R0) ([#24](https://github.com/dgrauet/suzerain/issues/24)) ([99716e3](https://github.com/dgrauet/suzerain/commit/99716e3ba8ce65c434cf8b035e602bab3a679575))

## [0.4.1](https://github.com/dgrauet/suzerain/compare/v0.4.0...v0.4.1) (2026-05-04)


### Features

* **mcp:** expose suzerain over MCP via optional `mcp` extra ([#22](https://github.com/dgrauet/suzerain/issues/22)) ([19ace2b](https://github.com/dgrauet/suzerain/commit/19ace2b7461d3480fd8568dace182aa249c7f216))
...
* **scaffold:** add --stack=node scaffolder (eslint + ts + vitest) ([99996dc](https://github.com/dgrauet/suzerain/commit/99996dc20e86cd5cef67fce2bbcb982f1d8d411d))

## [0.1.14](https://github.com/dgrauet/suzerain/compare/v0.1.13...v0.1.14) (2026-05-03)


### Features

* **adapters/node:** add Node/TS adapter with 6 rules (NODE_PK001-003, NODE_QU001-002, NODE_TS001) ([e6abae7](https://github.com/dgrauet/suzerain/commit/e6abae7eb8ba442ce0215279367273af253411dc))
