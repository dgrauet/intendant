...
def find_intendant_repos(root: Path, maxdepth: int = 2) -> list[Path]:
    """Find all directories under ``root`` containing a `.intendant.toml` marker.
